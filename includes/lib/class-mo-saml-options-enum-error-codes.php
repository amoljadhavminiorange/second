...
class Mo_Saml_Options_Enum_Error_Codes extends Mo_SAML_Basic_Enum {
	...
	public static $error_codes = array(
		...
		'WPSAMLERR013' => array(
			'code'           => 'WPSAMLERR013',
			'description'    => 'This error occurs when Destination in response doesn\'t match the current URL.',
			'fix'            => 'To fix this error, check Destination and Current URL mapping.',
			'cause'          => 'Destination not matching to Current URL',
			'testConfig_msg' => 'Destination does not match Current URL found in SAML Response.',
		),
	);
}
